...
##for debug
# tokenizationPath='output/toy/CorpustokenCop.pkl'
# CorpusStatsPath='output/toy/CorpusStats.pkl'
# inputDict={
...
for qid in tqdm(qrels,desc="processing query"):
    if qid not in dataset.scores_dict:
        continue
    ...
    DistillCandidates=dataset.scores_dict[qid]
